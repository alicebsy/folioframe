...
사람들과 함께할 때는 다양한 의견을 경청하고 자연스럽게 어우러지도록 돕는 것을 중요하게 생각합니다. 초등학교 3학년부터 고등학교 2학년까지 매년 **학급 반장, 중3 전교부회장, 고2 중국어과 과장**을 역임하고 50명 규모 스포츠 연합동아리 회장을 맡으며, 구성원 한 사람 한 사람을 세심하게 챙기고 **따뜻하면서도 명확하게 소통하며 팀을 이끄는 리더십**을 다져왔습니다.`;
