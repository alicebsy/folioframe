...
export const projects: Project[] = [
  {
    ...
    troubleshooting:
      "입력 상태를 **프로필·프로젝트 단위로 분리**하고, **서버 검증과 미리보기 데이터를 공통 계약 타입으로 연결**했습니다.",
    result:
  ...
  },
  {
    ...
    troubleshooting: "**요청 키 기준 캐시 통합과 독립적인 에러 바운더리**를 적용하여, 실패한 영역만 선별적으로 재시도하도록 구성했습니다.",
    result: "**중복 요청을 60% 이상 절감**하고 일부 API 장애 시에도 정상 영역과 캐시된 마지막 상태를 중단 없이 제공했습니다.",
