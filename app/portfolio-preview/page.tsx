...
export const portfolio: Portfolio = {
  ...
  careers: [
    ...
    { id: "career-preview-2", organization: "웹 개발 스터디", role: "프론트엔드 팀원", period: "2025.07 – 2025.12", description: "**React 렌더링 최적화, 테스트 자동화, 웹 성능 사례**를 학습하고 코드 리뷰를 통해 개선 내용을 공유했습니다." },
      { id: "career-preview-3", organization: "데포르테 · 신촌×안암 연합 스포츠 동아리", role: "기획부원 · 기획부장 · 회장", period: "2023.03 – 2025.02", description: "초등학교 3학년부터 고등학교 2학년까지 매년 **학급 반장**, 중3 **전교부회장**, 고2 **중국어과 과장**을 역임하며 다져온 경험을 바탕으로 50명 규모의 연합 스포츠 동아리 '데포르테'를 운영했습니다. 정기 운동 및 교류 행사를 기획하고 총괄하며, 소외되는 부원 없이 모두가 즐겁게 참여할 수 있도록 세심하게 챙겼습니다. **따뜻하고 명확한 소통으로 구성원들의 높은 참여도와 끈끈한 단체 문화**를 이끌었습니다." },
  ],
  educations: [
